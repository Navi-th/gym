...
import { getDb, members, plans } from "@/shared/db";

/**
 * TEMPORARY smoke test — delete once the members CRUD lands.
 *
 * Proves, end to end, the one chain everything else depends on:
 *
 ...
 * claims, so we test it before building modules on top of it.
 *
 * It exercises the binding RAW as well as through Drizzle, so a failure tells
 * us which layer broke.
 */
